...
open class GameLogic: NSObject {
	...
	open func loadState() {
		let savedCurrentSceneIndex: Int? = 10//UserDefaults.standard.value(forKey: "currentSceneIndex") as? Int
		let savedCurrentChapterIndex: Int? = 0//UserDefaults.standard.value(forKey: "currentChapterIndex") as? Int
